...
public class DrawRouteFragment extends Fragment implements OnMapReadyCallback {
    ...
    public static DrawRouteFragment newInstance(LatLng departure, LatLng destination) {
        DrawRouteFragment mpf = new DrawRouteFragment(departure, destination);

        return mpf;
    }

    private DrawRouteFragment(LatLng departure, LatLng destination) {
    ...
    System.out.println("Dosao ovdje");
        ...
        LatLng second_marker = this.destination;
        mMap.addMarker(new MarkerOptions().position(second_marker).title("Destination"));

        LatLng zaragoza = this.departure;
        ...
        GeoApiContext context = new GeoApiContext.Builder()
                ...
                .build();
        DirectionsApiRequest req = DirectionsApi.getDirections(context, first_marker.latitude + "," + first_marker.longitude,
